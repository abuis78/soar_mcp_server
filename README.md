...
- ✨ `get_custom_function` additionally passes through the undocumented-but-real fields this build returns: **`is_read_only`** (the write-safety gate for the upcoming draft slice), `python_version`, `version`.
